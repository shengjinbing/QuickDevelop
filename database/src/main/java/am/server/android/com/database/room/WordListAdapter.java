...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.WordViewHolder> {
    ...
    private List<User> mWords; // Cached copy of words
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        if (mWords != null) {
            ...
            holder.wordItemView.setText(current.getUid()+","+current.getFirstName()+","+current.getLastName());
        } else {
    ...
    public void setWords(List<User> words){
        mWords = words;
