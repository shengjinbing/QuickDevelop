package com.modesty.quickdevelop.views.nested;
...
public class StickyNavLayout extends LinearLayout implements NestedScrollingParent
{
    ...
    private static final String TAG_1 = "StickyNavLayout_1";

    /**
     * 一定要按照自己的需求返回true，该方法决定了当前控件是否能接收到其内部View(非并非是直接子View)滑动时的参数；
     * 假设你只涉及到纵向滑动，这里可以根据nestedScrollAxes这个参数，进行纵向判
     * @param child
     * @param target
    ...
    /**
     * onNestedPreScroll该方法的会传入内部View移动的dx,dy，如果你需要消耗一定的dx,dy，就通过最后一个参数
    ...
    public boolean onNestedFling(View target, float velocityX, float velocityY, boolean consumed)
    {
        ...
        Log.d(TAG_1,target.toString());
        Log.d(TAG_1,"velocityX=="+velocityX+","+"velocityY=="+","+velocityY+"consumed=="+consumed);
