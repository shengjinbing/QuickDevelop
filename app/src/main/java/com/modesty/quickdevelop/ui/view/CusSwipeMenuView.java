...
public class CusSwipeMenuView extends ViewGroup {
    ...
    //存储的是当前正在展开的View
    private static CusSwipeMenuView mViewCache;
    ...
    public CusSwipeMenuView(Context context) {
        this(context, null);
    }

    public CusSwipeMenuView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CusSwipeMenuView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @param ios
     */
    public CusSwipeMenuView setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public CusSwipeMenuView setLeftSwipe(boolean leftSwipe) {
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        //展开就加入ViewCache：
        mViewCache = CusSwipeMenuView.this;
