...
import com.modesty.quickdevelop.adapter.TestRecyclerViewAdapter;
import com.modesty.quickdevelop.views.BaseRefreshRecyclerView;
import com.modesty.quickdevelop.views.decorations.SimpleItemDecoration;
    ...
    private void initView() {
        ...
        rcv_test.setOnRefreshAndLoadMoreListener(new BaseRefreshRecyclerView.OnRefreshAndLoadMoreListener() {
            ...
            public void onRefresh() {
                Toast.makeText(RefreshRecyclerViewActivity.this, "Refreshing", Toast.LENGTH_SHORT).show();
